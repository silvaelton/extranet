  ...
  class UserGroupPermissionNav
    ...
    def save
      ...
      @permission.each do |i|
        ...
        @user_group = Pivotal::UserNav.new(
          nav_id: i,
    ...
    def destroy
      ...
      @ids = @group_permission.permission_ids.split(',')
      @nav_permissions = @ids.map{|k| k.to_i}
      
      @user_nav_permissions = Pivotal::UserNav.where(user_id: self.user_id, nav_id: @nav_permissions)
      
      @user_nav_permissions.each { |k| k.destroy }
